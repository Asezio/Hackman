...
public class MovementComponent : BaseGridObject
{
    ...
    protected virtual void Update()
    {
        ...
        transform.position = Vector3.Lerp(GridPosition.AsToIntVectr2(), targetGridPosition.AsToIntVectr2(), progressToTarget);
    }
}

public static class ExtensionMethods
{
    public static Vector3 AsToIntVectr2(this IntVector2 vector2)
    {
